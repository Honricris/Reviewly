...
def create_app():
    ...
    from app.routes import product_routes, review_routes, chat_routes, health_routes, auth_routes, user_queries, user_routes, heatmap_routes
    ...
    api.add_namespace(heatmap_routes.api, path=f"{API_PREFIX}/heatmap") 
    return app
